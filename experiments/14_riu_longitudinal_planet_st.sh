...
MASTER_LOG="${LOG_DIR}/riu_longitudinal_planet_st_r40i40u20.log"
...
for seed in "${SEEDS[@]}"; do
  export SEED="$seed"
  csv="${RESULTS_DIR}/riu_longitudinal_planet_st_r40i40u20_seed${seed}.csv"
  ops_name="riu_longitudinal_planet_r40i40u20_seed${seed}"
  rm -f "$csv"
